...
class OfficeProfile:
    ...
    middleware_office: str
    greeting: str


SPRING_HILL = OfficeProfile(
    key="spring-hill",
    middleware_office="+17275919997",
