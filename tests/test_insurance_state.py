...
class InsuranceStateTests(unittest.TestCase):
    def test_absence_cannot_survive_a_new_resolution(self):
        ...
        checked = AcceptedInsurance('spring-hill', 0, None, absence, 'Self Pay', 'medical')
    ...
    def test_patient_revision_and_partial_write_guard(self):
        ...
        state.insurance.accepted = AcceptedInsurance('spring-hill', 0, 'chart-jane', None, 'Self Pay', 'medical')
        self.assertTrue(insurance_ready(state, 'medical'))
        state.insurance.registration_patient_id = 'chart-jane'
        state.insurance.registration_status = 'partial'
